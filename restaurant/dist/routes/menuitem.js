...
router.delete("/:itemId", isAuth_js_1.isAuth, isAuth_js_1.isSeller, menuitem_js_1.deleteMenuItem);
router.put("/status/:itemId", isAuth_js_1.isAuth, isAuth_js_1.isSeller, menuitem_js_1.toggleMenuItemAvailability);
